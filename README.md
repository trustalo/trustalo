...
| License | [Trustalo Source-Available Commercial License v1.0](LICENSE). Free for organizations under USD 1M revenue **and** USD 1M funding; commercial license required above. |
...
- **Source-available, free for the people who need it most.** Local dev, testing, evaluation, learning, and production use by qualified organizations are free. Larger orgs and SaaS resale require a commercial license. The full plain-English summary is in the [License](#license) section below; the [`LICENSE`](LICENSE) file is authoritative.
...
By contributing, you agree that your contributions are licensed under the same terms as this project — see the [License](#license) section below and the authoritative [`LICENSE`](LICENSE) file.

---

## License

Trustalo is **source-available** under the **Trustalo Source-Available Commercial License v1.0**. The authoritative text lives in [**`LICENSE`**](LICENSE) at the repo root.

> This is _not_ an OSI-approved open source license. The table below is a plain-English summary — [`LICENSE`](LICENSE) is binding.
...
| Modify and redistribute source copies (with [`LICENSE`](LICENSE) preserved) | Yes. |
| Repackaging as a hosted/SaaS offering you sell to third parties | Requires a commercial license. |

If your organization needs a commercial license, please open an issue or reach out via the contact details on the project page.
