...
| --- | --- | --- | --- |
| **SSO / SAML / advanced auth** | `sso` | Enterprise buying signal; high integration burden; not needed by SMBs | `packages/auth-provider-saml.ee/` _(scaffolded; SAML protocol logic to follow)_ |
